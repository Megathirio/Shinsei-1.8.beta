...
public class HashMaps {
    ...
    public HashMaps(){
        ...
        //Basic Ores
        basicOreMap.put(new Block[]{ShinseiOres.acanthiteOre, ShinseiBlocks.silverBlock}, new Item[]{ShinseiItems.silverDust, ShinseiItems.silverNugget, ShinseiItems.silverIngot});
        ...
        toolMap.put(ShinseiTools.silverPickaxe, new Item[]{ShinseiTools.silverPickaxeBlade, ShinseiTools.woodToolHandle, ShinseiTools.bookPickaxe, ShinseiTools.ironHammer, ShinseiItems.silverIngot});
        toolMap.put(ShinseiTools.silverShovel, new Item[]{ShinseiTools.silverShovelBlade, ShinseiTools.woodToolHandle, ShinseiTools.bookShovel, ShinseiTools.ironHammer, ShinseiItems.silverIngot});
        toolMap.put(ShinseiTools.silverSword, new Item[]{ShinseiTools.silverSwordBlade, ShinseiTools.woodToolHandle, ShinseiTools.bookSword, ShinseiTools.ironHammer, ShinseiItems.silverIngot});
