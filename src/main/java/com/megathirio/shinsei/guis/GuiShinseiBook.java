package com.megathirio.shinsei.guis;
...
public class GuiShinseiBook extends GuiScreen{
        ...
        public GuiShinseiBook()
        {
            bookPageTextures[0] = new ResourceLocation(
                    Ref.RESOURCE_PREFIX + "textures/gui/" + Names.books.SHINSEI + "_1.png");
        ...
        public void initGui()
        {
            ...
            buttonList.add(buttonNextPage = new NextPageButton(1,
                    offsetFromScreenLeft + 224, 156, true));
            buttonList.add(buttonPreviousPage = new NextPageButton(2,
                    offsetFromScreenLeft + 8, 156, false));
        }
        ...
        public void drawScreen(int parWidth, int parHeight, float p_73863_3_)
        {
            ...
            fontRendererObj.drawString(stringPageIndicator,
                    offsetFromScreenLeft - widthOfString + bookImageWidth - 22,
                    8, 0);
            fontRendererObj.drawSplitString(stringPageText[currPage],
                    offsetFromScreenLeft + 16, 16, 104, 0);
